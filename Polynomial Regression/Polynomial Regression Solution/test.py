...
df = pd.read_csv('assign2data1.txt')
...
print ('Correct cost is: 65279190347.9')
...
print('Correct theta is: [ 339119.45652174  110248.92164231   -6226.22668917]')
...
"""Prediction"""
"""Following code shows how to do prediction for unseen input vector

Use the value of theta to predict house prices with area 1650 square feet and 
3 bedrooms.

"""
unseen_x = np.array([1650,3])
"""
 You need to normalize the given x using mean and standard deviation obtained 
 earlier.
"""

unseen_x_norm=(unseen_x-mu)/sigma


grad_price = predict(unseen_x_norm,theta)
print('predicted price is= ', grad_price)

""" Numerical Gradient"""
new_x = np.column_stack((ones,x))

num_grad = numericalGradient(new_x,y)

print('Analytical theta = ', num_grad )
print('Correct analytical theta is: [ 87807.75019324    138.75587842  -8186.38287595]')

print('Numericall cost is= ', multiCostFunction(new_x,y,num_grad))
print('Correct Numerical cost is:  2066502781.71')

numerical_price = predict(unseen_x,num_grad)
print('predicted price with Normal Equation: ',numerical_price)
